...
"""
    ...
    if chart_type == "bar" and x_col and y_col:
        ...
        fig.add_trace(go.Bar(x=grp[x_col], y=grp[y_col], marker_color="#3b82f6"))

    elif chart_type == "line" and x_col and y_col:
        srt = df[[x_col, y_col]].dropna().sort_values(x_col)
        fig.add_trace(go.Scatter(x=srt[x_col], y=srt[y_col],
        ...
        fig.add_trace(go.Scatter(x=df[x_col], y=df[y_col],
                                  mode="markers", marker=dict(color="#8b5cf6", opacity=0.6)))

    elif chart_type == "histogram" and x_col:
        fig.add_trace(go.Histogram(x=df[x_col], marker_color="#f59e0b"))
