...
# AUTO-GENERATED — pipeline: demo_1
# Do not manually edit. Use /create_pipeline endpoint to regenerate.

PIPELINE_ID     = "pipeline_demo_1"
CONNECTOR_TYPE  = "csv"
FOLDER_PATH     = None
FILE_PATH       = "/home/spark/demo_2.csv"
SHEET_URL       = None
API_URL         = None
SYNC_MODE          = "full"
...
DATASET_PIPELINE_CON  = "/opt/airflow/dataset/pipeline_demo_1"
PIPELINE_CON_ROOT     = "/opt/airflow/user_data/pipeline_demo_1"
