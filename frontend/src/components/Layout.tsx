...
// Admin-only nav group — appended conditionally in the component below,
// not in the static NAV_GROUPS array, so non-admins never even see it
  ...
  return (
    <div className="flex h-full">
      <aside className="relative flex w-[248px] shrink-0 flex-col border-r border-slate-200/70 bg-white/70 backdrop-blur">
        ...
        {/* Real logged-in user + logout — replaces the old hardcoded "Gaurav" block */}
        <div className="flex items-center justify-between border-t border-slate-200/70 px-3 py-2">
          ...
          <button className="icon-btn !h-7 !w-7" title="Log out" onClick={logout}>
